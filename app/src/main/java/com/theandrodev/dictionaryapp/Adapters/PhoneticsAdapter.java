...
import com.theandrodev.dictionaryapp.Models.Phonetics;

import com.theandrodev.dictionaryapp.R;
import com.theandrodev.dictionaryapp.ViewHolders.PhoneticViewHolder;
...
public class PhoneticsAdapter extends RecyclerView.Adapter<PhoneticViewHolder>{
    ...
    public void onBindViewHolder(@NonNull PhoneticViewHolder holder, int position) {
        holder.phonetic_tv.setText(phoneticsList.get(position).getText());
